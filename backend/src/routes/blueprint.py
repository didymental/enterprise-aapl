...
from ..controllers.order_controller import get_reporting_amount_by_hour_interval, get_reporting_amount_by_city, get_running_order_qty_total_by_city
...
blueprint.route('/order-qty/city', methods=['GET'])(get_running_order_qty_total_by_city)
